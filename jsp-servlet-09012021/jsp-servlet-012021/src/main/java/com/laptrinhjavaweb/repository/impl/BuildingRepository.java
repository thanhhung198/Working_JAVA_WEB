...
public class BuildingRepository extends SimpleJpaRepository<BuildingEntity> implements IBuildingRepository {
	...
	/*
	 * @Override public List<BuildingEntity> findAll(Map<String, Object> params,
	 * Pageable pageable) { return this.findAll(params, pageable);//Dang extends tu
	 * SimpleJpaRepository do da co findAll
	 * 
	 * 
	 ...
	 * 
	 * 
	 * //student code String name = (String) params.get("name"); String district =
	 * (String) params.get("district"); StringBuilder where = new StringBuilder("");
	 ...
	 * 
	 * 
	 * 2 year exp //Tao mang de luu tru keys(ten field),values
	 * 
	 * }
	 */
